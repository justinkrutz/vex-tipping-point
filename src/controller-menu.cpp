...
void create_folder_structure() {
  root_folder = new MenuFolder("", {
      new MenuFolder("Without Kickstand", {
        ...
        new MenuAutonomous("Right Center Shoot", autonroutines::right_center_shoot),
      ...
      new MenuFolder("With Kickstand", {
        ...
        new MenuAutonomous("K Right Center Shoot", autonroutines::kickstand_right_center_shoot),
